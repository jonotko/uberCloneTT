...
//  UberCloneTT
//
//  Created by Jonathan Agarrat on 2/4/20.
...
extension UIView {
    ...
    func inputContainerView(image: UIImage, textField: UITextField? = nil, segmetedControl: UISegmentedControl? = nil) -> UIView {
        ...
        if let textField = textField {
            ...
            textField.anchor(left: imageView.rightAnchor, right: view.rightAnchor, paddingLeft: 8, paddingBottom: 8)
            textField.centerY(inView: view)
        }
        
        if let segmetedControl = segmetedControl {
            imageView.anchor(top: view.topAnchor, left: view.leftAnchor, paddingTop: -8, paddingLeft: 8, width: 24, height: 24)
            view.addSubview(segmetedControl)
            
            segmetedControl.anchor(left: view.leftAnchor, right: view.rightAnchor, paddingLeft: 8, paddingRight: 8)
            segmetedControl.centerY(inView: view, constant: 8)
        }
